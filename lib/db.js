...
export async function ensureTables() {
  ...
  try {
    ...
    `;
    await sql`ALTER TABLE sessions ADD COLUMN IF NOT EXISTS source TEXT NOT NULL DEFAULT 'unknown'`;
    await sql`
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_sessions_source ON sessions(source)`;
  } catch (err) {
